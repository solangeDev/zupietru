    ...
    <div class="container-fluid mb-4 mt-2">
           <div class="container-fluid mb-3">
            ...
            <div class="row sum">
                ...
                <div class="col-6">
                    <p class="lead text-right">€ {{getTotal}}</p>
                </div>
                <div class="hr-full mb-3"></div>
            </div>
            <div class="row sum">
            ...
            <div class="row mt-3">
              <div class="col-12">
                      ...
                      <div class="form-group">
                              <button type="button" class="btn btn-danger btn-block" @click="checkout()">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalDeliveryLabel">Procedi all' acquisto</h5>
                ...
                <div class="modal-body">
                  ...
                  <router-link to="/create-account" data-dismiss="modal" class="btn btn-danger btn-lg text-uppercase text-white btn-block">
                    Registrati
                  </router-link>

                  <h4 class="mt-4 mb-2">Continua senza registrarti</h4>
                  <router-link to="/editaddress" data-dismiss="modal" class="btn btn-dark btn-lg text-uppercase text-white btn-block">Continua</router-link>
...
<script>
    export default {
        ...
        methods:{
         checkout(){           
            if(this.total<this.monto_delivery){
              var msj='Importo minimo per la consegna €'+this.monto_delivery;
              Vue.swal({
                title: 'Errore!!',
                text: msj,
                type: 'error',
              ...
              if(user.length==0){
                $('#modalDelivery').modal('show') //Modal
              }else{
          ...
          AddCant(idItem,oper,item){
            ...
            if(this.$store.getters.getProducts(this.id_presentation).length==0){
               this.$router.push('/catalog/'+this.id_presentation);
            }
          }
        }
