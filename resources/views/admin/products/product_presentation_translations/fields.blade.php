...
<div class="form-group {{$errors->has('status_id') ? 'has-error' : ''}} col-sm-6 col-sm-offset-3">
    ...
    {!! Form::select('status_id', $statuses, @$productPresentationTranslation->productPresentation->status_id, ['class' => 'form-control', 'placeholder' => $tags['back_general_select']]) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.productPresentations.index') !!}" class="btn btn-default">{{ $tags['back_general_back'] }}</a>
</div>
