 ...
 *
 * @property \App\Models\Admin\EventCategory eventCategory
...
class Event extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Admin\EventCategory::class);
    }
    ...
    public function row()
    {
        return $this->morphOne(\App\Models\Admin\Rows::class, 'rowable');
    }
}
