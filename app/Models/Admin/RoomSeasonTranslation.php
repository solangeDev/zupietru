...
/**
 * Class RoomSeasonTranslation
 * @package App\Models\Admin
 * @version August 1, 2018, 6:10 pm UTC
 *
 * @property \App\Models\Admin\Language language
 * @property \App\Models\Admin\RoomSeason roomSeason
 ...
 * @property integer room_season_id
 * @property integer language_id
 * @property string name
 * @property string description
 */
class RoomSeasonTranslation extends Model
{
    use SoftDeletes;

    public $table = 'room_season_translations';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function roomSeason()
    {
        return $this->belongsTo(\App\Models\Admin\RoomSeason::class);
    }
}
