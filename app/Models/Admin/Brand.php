...
class Brand extends Model
{
    ...
    public function scopeByLanguage($query, $language_code)
    {
        ...
        return $query->join('brand_translations', 'brands.id', '=', 'brand_translations.brand_id')
                     ->where('brand_translations.language_id', $language->id)
                     ->select('brands.id', 'brand_translations.name');
    }
}
