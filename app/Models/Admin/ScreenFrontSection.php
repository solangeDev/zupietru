...
/**
 * Class ScreenFrontSection
 * @package App\Models\Admin
 * @version August 1, 2018, 9:35 pm UTC
 *
 * @property \App\Models\Admin\FrontSection frontSection
 ...
 * @property integer front_section_id
 * @property integer language_id
 */
class ScreenFrontSection extends Model
{
    use SoftDeletes;

    public $table = 'screens_front_sections';
    ...
    {
        return $this->belongsTo(\App\Models\Admin\FrontSection::class);
    }
    ...
    {
        return $this->belongsTo(\App\Models\Admin\TagTranslation::class);
    }
}
