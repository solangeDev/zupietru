...
class OrderDetailController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.products.order_details.index')
    ...
    {
        return view('admin.products.order_details.create');
    }
    ...
    public function store(CreateOrderDetailRequest $request)
    {
        ...
        return redirect(route('admin.products.orderDetails.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.products.order_details.show')->with('orderDetail', $orderDetail);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.order_details.edit')->with('orderDetail', $orderDetail);
    }
